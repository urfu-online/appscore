...
from app.cdn.models import License, LicenseCreate, LicenseUpdate
...
def get_license(*, session: Session, token: str) -> License | None:
    statement = select(License).where(License.token == token)
